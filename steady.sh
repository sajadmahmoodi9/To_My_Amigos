#!/bin/bash
# =====================================================================================================
# Copyright (C) steady.sh just for fun project
# =====================================================================================================
...
VOLUNTARYCHECK=0
I=1
BOT=To_My_Amigos  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script just for fun project" >&2
	echo ""
	exit 1
      ;;
	h)
